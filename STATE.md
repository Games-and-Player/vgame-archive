...
> 最后更新：2026-06-16（VOL.2 全部正文 OCR 转录完成，整页扫描图生成中）

## 项目目标

把 90 年代中文游戏杂志（《Game 集中营》系列）数字化为可检索的静态网站归档。
...
| 期号 | 状态 | 文件数 |
|---|---|---|
| VOL.1（1994 试刊号） | **全部完成** — 72 页 OCR + 整页扫描图 + 站点上线 | 30 篇 + 72 张 webp |
| VOL.2（1994 第二辑） | **OCR 全部完成** — 72 页正文转录，扫描图生成中 | 27 篇 + 生成中 |
